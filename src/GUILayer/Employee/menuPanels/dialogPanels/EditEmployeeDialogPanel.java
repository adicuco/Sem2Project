...
public class EditEmployeeDialogPanel extends JDialog{
	...
	public EditEmployeeDialogPanel(int employeeId) {
	...
	private void initialize() {
		...
		Employee emp = empCtr.findEmployee(employeeId);
		...
		comboAccessLvl.setEnabled(false);
		...
		gl_pnlButtons.setHorizontalGroup(
			gl_pnlButtons.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlButtons.createSequentialGroup()
					.addGap(48)
					.addComponent(btnSave, GroupLayout.PREFERRED_SIZE, 145, GroupLayout.PREFERRED_SIZE)
					.addGap(157)
					.addComponent(btnEdit, GroupLayout.PREFERRED_SIZE, 168, GroupLayout.PREFERRED_SIZE)
	...
	private void createEvents(){
		...
		btnEdit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				comboAccessLvl.setEnabled(true);
	...
	private void fillCombo() {
		...
		comboAccessLvl.setModel(new DefaultComboBoxModel<>(AccessLvl.values()));
		
		comboAccessLvl.setSelectedItem(empCtr.findEmployee(employeeId).getAccessLvl());
